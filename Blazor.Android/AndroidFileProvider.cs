...
internal class AndroidFileProvider(AssetManager assets, string contentRootDir) : IFileProvider
{
    public IDirectoryContents GetDirectoryContents(string subpath)
    {
        var resolvedPath = Path.Join(contentRootDir, subpath);
    ...
    {
        var resolvedPath = Path.Join(contentRootDir, subpath);
        return new AndroidAssetFileInfo(assets, resolvedPath);
    }
    ...
    private sealed class AndroidAssetFileInfo : IFileInfo
    {
        ...
        public AndroidAssetFileInfo(AssetManager assets, string filePath)
        {
            _assets = assets;
            _filePath = filePath;
        ...
        public Stream CreateReadStream() => _assets.Open(_filePath);
    }
